...
def main():
    ...
    parser.add_argument("--wheel-name", required=True, help="Name of the wheel being tested")
    ...
    parser.add_argument("--output-dir", required=True, help="Directory to save the plot")
    ...
    try:
        ...
        plt.title(f"TDE Displacement Field\n"
